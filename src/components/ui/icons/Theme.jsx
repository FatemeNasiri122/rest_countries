...
const Theme = () => {
    return (
        <svg className="stroke-black dark:stroke-white-color" width="24" height="24"
            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="vuesax/linear/brush">
                <g id="vuesax/linear/brush_2">
                    <g id="brush" clipPath="url(#clip0_2409_23695)"><path id="Vector"
                        ...
                        <path
                            id="Vector_3" d="M7.99023 2V7" strokeWidth="1.5" strokeLinecap="round"
                            strokeLinejoin="round" /><path id="Vector_4" d="M12 2V4" strokeWidth="1.5"
